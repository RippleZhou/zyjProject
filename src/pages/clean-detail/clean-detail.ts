...
import {CleanOrderPage} from "../clean-order/clean-order";
import {ROUTER} from "../../service/router.service";

/**
 * Generated class for the CleanDetailPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-clean-detail',
  templateUrl: 'clean-detail.html',
})
export class CleanDetailPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CleanDetailPage');
  }

  gotoCleanOrder() {
    this.ROUTER.go(ROUTER.CLEANORDER);
  }
}
